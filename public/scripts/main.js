...
var Process = function () {
    ...
    _createClass(Process, [{
        ...
        value: function display(event) {
            ...
            var $text = (0, _jquery2.default)(event.currentTarget).parent().find(this.selectors.text);
            var $allText = this.$element.find(this.selectors.text);
            var $number = this.$element.find(this.selectors.number);

            $allText.removeClass(this.classes.display);
            $text.addClass(this.classes.display);

            $number.removeClass(this.classes.active);
            (0, _jquery2.default)(event.currentTarget).addClass(this.classes.active);
        }
    }]);
